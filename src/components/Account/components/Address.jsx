    ...
    <div className="address">
      <div className="container">
        <div className="address-head">
          <h2 style={{fontSize: "24px", fontWeight: "500"}}>Địa chỉ của tôi</h2>
          <Button onClick={handleOpen} variant="contained" color="error" style={{paddingTop: "10px"}}>
            + Thêm địa chỉ
          </Button>
        </div>
        <hr></hr>
            ...
            address.address.map((item) => (
              <div className="address-content-card">
                ...
                <div className="address-content-card-settings">
                  ...
                  >
                    <Box sx={style}>
                      <h2 style={{fontSize: "24px", fontWeight: "500", textAlign: "center", marginBottom: "20px"}}>Cập nhật địa chỉ</h2>
                      <form
                        method="POST"
                      ...
                      >
                        ...
                        <div className="d-flex justify-content-end" style={{gap: "5px", marginTop: "15px"}}>
                          <Button variant="outlined" color="error" onClick={handleCloseUpdate} style={{paddingTop: "10px", fontSize: "14px"}}>
                            Hủy
                          </Button>
                          <Button type="submit" color="error" variant="contained" style={{paddingTop: "10px", fontSize: "14px"}}>
                            Hoàn thành
                          </Button>
                        </div>
                      </form>
        ...
        <Modal
          ...
          aria-describedby="modal-modal-description"
        >
          <FormAddress address handleClose={handleClose} title={"Thêm mới địa chỉ"} style></FormAddress>
        </Modal>
        ...
        >
          <Box sx={styles}>
            ...
            <div className="d-flex justify-content-end" style={{gap: "5px", marginTop: "10px"}}>
              <Button variant="outlined" color="error" onClick={handleCloseDelete} style={{fontSize: "14px", marginTop: "10px"}}>Hủy</Button>
              <Button variant="contained" color="error" onClick={() => deleteAddress(deleteId)} style={{fontSize: "14px", marginTop: "10px"}}>
                Xóa
              </Button>
            </div>
          </Box>
