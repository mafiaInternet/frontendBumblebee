      ...
      <TabContext value={value}>
        <Box sx={{ borderBottom: 1, borderColor: "divider", backgroundColor: "white" }}>
          <TabList onChange={handleChange} aria-label="lab API tabs example">
            <Tab label="Voucher của tôi" value="1" style = {{ fontSize: "16px", fontWeight: "500" }}/>
            <Tab label="Voucher của đối tác" value="2" style = {{ fontSize: "16px", fontWeight: "500" }}/>
          </TabList>
        </Box>
        ...
        <TabPanel value="2" style={{textAlign: "center", fontSize: "16px"}}> Không có dữ liệu </TabPanel>
      </TabContext>
    </Box>
    </div>
  );
