  ...
  return (
    <div className="register">
      <form className="register-form" onSubmit={handleSubmitRegister}>
        <Typography class="title" style={{fontSize: "35px", fontWeight: "500"}}>Đăng ký</Typography>
        <Grid container spacing={3}>
         ...
         <Grid item xs={12}>
          ...
          <Grid item xs={12}>
            <TextField required id="password" name="password" label="Mật khẩu" fullWidth 
          ...
          <Grid item xs={12}>
            <TextField required id="confirmPassword" name="confirmPassword" label="Xác nhận mật khẩu" fullWidth 
