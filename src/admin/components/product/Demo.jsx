      ...
      <Grid item xs={12} container spacing={1}>
        ...
        <Grid item xs={11.2} container spacing={1}>
          <Grid item xs={4}>
            ...
            <input type="text" name="colorName" style={{borderRadius: "10px", padding: "10px", fontSize: "14px", border: "1px solid"}}></input>
          </Grid>
          <Grid item xs={4}>
            <label style={{fontSize: "18px"}}>Kích Thước</label>
            <input type="text" name="sizes" style={{borderRadius: "10px", padding: "10px", fontSize: "14px", border: "1px solid"}}></input>
          </Grid>
          <Grid item xs={4}>
            <label style={{fontSize: "18px"}}>Số lượng (mỗi size)</label>
            <input type="text" name="quantity" style={{borderRadius: "10px", padding: "10px", fontSize: "14px", border: "1px solid"}}></input>
          </Grid>
        </Grid>
      </Grid>,
    ]);
          ...
          <Grid container spacing={1}>
            <Grid item xs={6}>
              ...
              <input
                ...
                required
                style={{borderRadius: "10px", padding: "10px", fontSize: "14px", border: "1px solid"}}
              ></input>
            </Grid>
            <Grid item xs={6}>
              <label style={{fontSize: "18px"}}>Loại sản phẩm</label>
              <select name="category" style={{borderRadius: "10px", padding: "10px", fontSize: "14px", border: "1px solid"}}>
                {category.categories &&
            ...
            <Grid item xs={12}>
              <button className="btn btn-primary" type="submit" style={{padding: "10px 18px", fontSize: "15px", backgroundColor: "#1976d2", borderRadius: "4px"}}>
                Thêm sản phẩm
              </button>
            </Grid>
          </Grid>
